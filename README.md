...
| Public-key crypto | X25519, NIST P-256/P-384/P-521, Ed25519, RSA-PSS, ML-KEM, ML-DSA, approved hybrid groups | RFC 7748 X25519, NIST P-256 ECDH, ECDSA P-256/P-384/P-521, and RSA-PSS SHA-256/384/512 verification are present; signing and post-quantum algorithms remain required |
...
| ECDSA P-256/P-384/P-521 and RSA-PSS verification | Fixed-width raw-signature verifiers, bounded RSA modular exponentiation, strict DER signature decoding, SHA-256/384/512 certificate verification, curve/RSA SPKI validation, and mutation failures | Independent raw-signature vectors; real X.509 certificates signed with ECDSA-with-SHA256, SHA384, SHA512, and RSA-PSS-SHA256; malformed/modified signature failures | Constant-time audit, independent differential corpus, measured allocation/copy counts, target execution, formal benchmark, and security review |
