...
| ECDSA P-256/P-384/P-521 and RSA-PSS | RFC 6979 P-256/P-384/P-521 raw signing plus fixed-width raw-signature verification, bounded RSA modular exponentiation, strict DER signature decoding, SHA-256/384/512 certificate verification, curve/RSA SPKI validation, and mutation failures | RFC 6979 P-256/P-384/P-521 signing vectors; independent raw-signature vectors; real X.509 certificates signed with ECDSA-with-SHA256, SHA384, SHA512, and RSA-PSS-SHA256; malformed/modified signature failures; targeted ASan passes for P-256/P-384/P-521 signing | Constant-time audit, independent differential corpus, measured allocation/copy counts, target execution, formal benchmark, and security review; TLS selection remains rejected until these gates pass |
