...
final class HPKETests: XCTestCase {
    func testRFC9180X25519ChaChaBaseVector() throws {
        let recipientPrivate = try X25519PrivateKey(bytes: bytes(
            "8057991eef8f1f1af18f4a9491d16a1ce333f695d4db8e38da75975c4478e0fb"
        ).span)
        let entropy = FixedEntropy(bytes: bytes(
        ...
        XCTAssertEqual(
            ...
            Array(bytes("1c5250d8034ec2b784ba2cfd69dbdb8af406cfe3ff938e131f0def8c8b60b4db21993c62ce81883d2dd1b51a28"))
        )
    ...
    func testRFC9180X25519ChaChaAuthVector() throws {
        ...
        let senderPrivate = try X25519PrivateKey(bytes: bytes(
        ...
        XCTAssertEqual(
            copy(ciphertext.span),
            Array(bytes("ab1a13c9d4f01a87ec3440dbd756e2677bd2ecf9df0ce7ed73869b98e00c09be111cb9fdf077347aeb88e61bdf"))
        )
        let opened = try recipient.open(
            ciphertext: ciphertext.span,
            authenticatedData: aad.span
    ...
    func testRFC9180X25519ChaChaPSKVector() throws {
        ...
        XCTAssertEqual(
            copy(ciphertext.span),
            Array(bytes("4a177f9c0d6f15cfdf533fb65bf84aecdc6ab16b8b85b4cf65a370e07fc1d78d28fb073214525276f4a89608ff"))
        )
    ...
    func testRFC9180X25519ChaChaAuthPSKVector() throws {
        ...
        XCTAssertEqual(
            copy(ciphertext.span),
            Array(bytes("9aa52e29274fc6172e38a4461361d2342585d3aeec67fb3b721ecd63f059577c7fe886be0ede01456ebc67d597"))
        )
        let opened = try recipient.open(ciphertext: ciphertext.span, authenticatedData: aad.span)
        XCTAssertEqual(copy(opened.span), Array(plaintext))
        let exported = try sender.export(ContiguousArray<UInt8>().span, length: 32)
