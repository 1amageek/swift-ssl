...
final class SHA3Tests: XCTestCase {
    func testSHA3EmptyKnownAnswers() throws {
        ...
        XCTAssertEqual(copy(sha3_256.span), bytes("a7ffc6f8bf1ed76651c14756a061d662f580ff4de43b49fa82d80a4b80f8434a"))
        ...
        XCTAssertEqual(copy(sha3_512.span), bytes("a69f73cca23a9ac5c8b567dc185a756e97c982164fe25859e0d1dcc1475c80a615b2123af1f5f94c11e3e9402c3ac558f500199d95b6d3e301758586281dcd26"))
    }
    ...
    func testSHA3IncrementalClone() throws {
        ...
        XCTAssertEqual(copy(first.span), bytes("3a985da74fe225b2045c172d6bd390bd855f086e3e9d525b46bfe24511431532"))
    }
    ...
    func testSHAKEKnownAnswersAndOutputLengthValidation() throws {
        ...
        XCTAssertEqual(copy(shake128.span), bytes("7f9c2ba4e88f827d616045507605853ed73b8093f6efbc88eb1a6eacfa66ef26"))
        ...
        XCTAssertEqual(copy(shake256.span), bytes("46b9dd2b0ba88d13233b3feb743eeb243fcd52ea62b81b82b50c27646ed5762fd75dc4ddd8c0f200cb05019d67b592f6fc821c49479ab48640292eacb3b7c4be"))
