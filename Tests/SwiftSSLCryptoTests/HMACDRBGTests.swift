...
final class HMACDRBGTests: XCTestCase {
    func testSP80090AStyleDeterministicGeneration() throws {
        ...
        XCTAssertEqual(
            output,
            bytes("acb4c0527346343f45266a99a5ea86e9493b69635f509ed6871d4c871f93613b70af78045a86189e93f2adcbd7f4533c1bf27f60b443c1f0514ffaaf3102514a61b41b7d8c9916021978e3f64118ca08")
        )
    }
    ...
    func testAdditionalInputMatchesIndependentVector() throws {
        ...
        XCTAssertEqual(
            output,
            bytes("105183504d7ca550b85a69a1039b9533c4b26b7d62910c804988e067bab5c48c76c5acce2cf90ebe7b14ed0bf1e493c7c5d5ac1614dc8c3d9f1b9f48f3e4bf8c")
        )
    }
    ...
    func testOutputLimitFailsBeforeMutation() throws {
        ...
        var output = ContiguousArray<UInt8>(repeating: 0xA5, count: HMACDRBG.maximumRequestByteCount + 1)
        let original = output
        do {
            var outputSpan = output.mutableSpan
            try generator.generate(into: &outputSpan)
            ...
            XCTAssertEqual(
                error,
                .outputTooLarge(limit: HMACDRBG.maximumRequestByteCount, actual: HMACDRBG.maximumRequestByteCount + 1)
            )
        }
