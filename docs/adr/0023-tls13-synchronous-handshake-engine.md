...
authentication, and AES-128-GCM with SHA-256. Unsupported cipher suites and
...
fragment buffering, resumption, 0-RTT, ECH, and post-handshake key update remain
separate responsibilities and are not represented as successful behavior by
this engine.
