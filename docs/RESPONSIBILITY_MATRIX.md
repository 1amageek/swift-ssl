...
| Remaining cryptography | P-384/P-521, ECDSA, RSA-PSS, ML-KEM, ML-DSA, HPKE, and hybrid constructions remain outside the callable implementation | Native compilation of protocols only | Concrete implementations, official vectors, negative/differential/target/performance gates |
...
| `SwiftSSL` façade | Explicit AES-GCM, SHA-2, SHA-3/SHAKE, HMAC-SHA-256, HKDF-SHA-256, X25519, and P-256 ECDH adapters; lower modules remain separately importable products | Symmetric, SHA-2, SHA-3/SHAKE, HMAC-SHA-256, HKDF-SHA-256, X25519, and P-256 have Native/WASI/Embedded WASI execution | Full application-facing TLS composition and a reviewed stability surface |
