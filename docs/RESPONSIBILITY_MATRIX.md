...
| Classical signature | Ed25519; ECDSA P-256/384/521; RSA-PSS SHA-256/384/512 | Required | Ed25519 and RSA-PSS SHA-256/384/512 verification are production paths; RFC 6979 P-256/P-384/P-521 signing/verification remains release-gated until constant-time and differential gates pass |
...
| Remaining cryptography | ML-KEM, ML-DSA, P-256/P-384/P-521 HPKE KEMs, and hybrid constructions remain outside the callable implementation; X25519 HPKE is callable; RSA-PSS is verification-only | Native vectors cover RFC 9180 X25519 HPKE A.2 base plus all four modes and all supported KDF/AEAD combinations, RFC 6979 P-256/P-384/P-521 signing, RSA-PSS, and P-384/P-521 verification; RSA-PSS also has Montgomery differential, sanitizer, and three-target runtime evidence; matching P-256/P-384/P-521 TLS CertificateVerify handshakes complete | Constant-time/differential release gates for P-256/P-384/P-521, TLS interoperability, signing, ML-KEM, ML-DSA, P-256 HPKE, ECH, and hybrid constructions |
