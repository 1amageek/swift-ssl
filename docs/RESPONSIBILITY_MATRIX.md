...
| HPKE | RFC 9180 X25519 DHKEM Base, PSK, Auth, and AuthPSK modes with HKDF-SHA256/384/512 and AES-GCM/ChaCha20-Poly1305 | Required | X25519 profile is callable with distinct sender/recipient contexts, precomputed key-pair ownership, exact in-place payload APIs, sequence-bound nonces, a wiped exporter-secret owner, typed failures, RFC A.2 vectors for all modes, and Native/WASI/Embedded runtime validation; P-256 DHKEM remains separate work |
