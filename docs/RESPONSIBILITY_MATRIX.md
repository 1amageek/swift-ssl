...
| Remaining cryptography | ML-KEM, ML-DSA, P-256/P-384/P-521 HPKE KEMs, and hybrid constructions remain outside the callable implementation; X25519 HPKE is callable; P-256/P-384/P-521 signing, RSA-PSS, and P-384/P-521 verification are validation-only | Native vectors cover RFC 9180 X25519 HPKE A.2 base plus all four modes and all supported KDF/AEAD combinations, RFC 6979 P-256/P-384/P-521 signing, RSA-PSS, and P-384/P-521 verification | Constant-time/differential release gates for P-256/P-384/P-521/RSA-PSS, TLS selection, signing, ML-KEM, ML-DSA, P-256 HPKE, ECH, and hybrid constructions |
