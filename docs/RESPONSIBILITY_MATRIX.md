...
| Classical signature | Ed25519; ECDSA P-256/384/521; RSA-PSS SHA-256/384/512 | Required | Ed25519 and ECDSA P-256/P-384/P-521 verification are callable for the X.509 path; TLS authentication, signing, and RSA-PSS remain required |
...
| Remaining cryptography | ECDSA signing, RSA-PSS, ML-KEM, ML-DSA, HPKE, and hybrid constructions remain outside the callable implementation; P-384/P-521 verification is validation-only | Native vectors now cover P-384/P-521 verification; protocol compilation remains separate | Constant-time/differential release gates for P-256/P-384/P-521, TLS selection, signing, RSA-PSS, ML-KEM, ML-DSA, HPKE, and hybrid constructions |
