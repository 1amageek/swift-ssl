...
| TLS/DTLS | TLS 1.3 AEAD record protector plus sealed profile/action-batch models | Native round trips for AES-128-GCM, AES-256-GCM, and ChaCha20-Poly1305, padding, sequence and authentication-failure paths | TLS transcript/key-schedule and handshake engines, DTLS state, capability suspension, full state/interop/target evidence |
