...
| Remaining cryptography | Additional approved hybrid constructions remain outside the callable implementation; ML-DSA-44/65/87, ML-KEM, X25519MLKEM768, and X25519 HPKE are callable; RSA-PSS and NIST ECDSA are verification-only | Native vectors cover all FIPS 204 ML-DSA parameter sets, FIPS 203, and RFC 9180 X25519 HPKE; ML-DSA and X25519MLKEM768 have production-path and three-target execution; RSA-PSS has Montgomery differential, sanitizer, and three-target runtime evidence; NIST ECDSA has independent verification vectors | ECH, additional approved hybrid constructions, and their completion gates |
