...
| Classical signature | Ed25519; ECDSA P-256/384/521; RSA-PSS SHA-256/384/512 | Required | Ed25519, ECDSA P-256/P-384/P-521, and RSA-PSS SHA-256/384/512 verification are callable for the X.509 path; TLS authentication and signing remain required |
...
| Remaining cryptography | ECDSA signing, ML-KEM, ML-DSA, HPKE, and hybrid constructions remain outside the callable implementation; RSA-PSS and P-384/P-521 verification are validation-only | Native vectors now cover RSA-PSS and P-384/P-521 verification; protocol compilation remains separate | Constant-time/differential release gates for P-256/P-384/P-521/RSA-PSS, TLS selection, signing, ML-KEM, ML-DSA, HPKE, and hybrid constructions |
