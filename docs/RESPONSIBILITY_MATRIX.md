...
| `SwiftSSL` façade | Explicit SHA-256, HMAC-SHA-256, and HKDF-SHA-256 protocol adapters; lower modules remain separately importable products | SHA-256, HMAC-SHA-256, and HKDF-SHA-256 have Native/WASI/Embedded WASI execution | Application-facing TLS composition and a reviewed stability surface |
