...
enum TargetValidationCommand {
  ...
  private static func validateP256() throws {
    ...
    let expectedDeterministicSignature = ContiguousArray<UInt8>([
      0xCE, 0x42, 0x83, 0x5B, 0x76, 0x0B, 0x8F, 0xB3,
      0x09, 0x44, 0xF2, 0x4F, 0x85, 0x95, 0xDE, 0x04,
      0x0C, 0x52, 0x05, 0x44, 0x98, 0x13, 0x3E, 0x46,
      0x59, 0x03, 0x76, 0x63, 0x9D, 0x08, 0x09, 0x0A,
      0x6E, 0x17, 0x2E, 0xCA, 0xF2, 0x58, 0x36, 0xD2,
      0x5E, 0x90, 0x86, 0xDE, 0xC0, 0x61, 0xBA, 0x42,
      0xB2, 0x38, 0xF9, 0x44, 0x81, 0xE5, 0xF8, 0x30,
      0x33, 0x48, 0x0F, 0x97, 0x3A, 0xAE, 0x0D, 0x3E,
    ])
